    ...
    <div class="flex fex-row w-full">
        ...
        <div class="w-full lg:w-8/12 p-2">
            <div class="flex flex-col w-full h-full bg-white border border-gray-200 shadow rounded p-5">
                <div class="">
                    <div class="flex mt-1 items-center flex-row border rounded border-1 border-gray-300" id="qadd-target-header">
                        <input type="text" id="qadd-header" placeholder="Soru başlığı girin" class="w-full text-sm border-0 outline-0 focus:ring-0 text-base p-0 p-3">
                    </div>
                    <div class="flex mt-2 flex-row border rounded border-1 border-gray-300 overflow-hidden" id="qadd-target-content">
                        <textarea class="w-full text-sm border-r-0 border-t-0 border-b-0 border-0 border-gray-300 outline-0 focus:ring-0 p-0 outline-0 focus:outline-0 focus:border-gray-300 p-3 focus:ring-0 ring-0 min-h-[200px]" placeholder="Sormak istediğiniz sorunun içeriği nedir ?" id="qadd-content"></textarea>
                    </div>

                    <div class="flex mt-2 items-center flex-row border rounded border-1 border-gray-300" id="qadd-target-image">
                        <p class="hidden min-w-[110px] p-3">Soru başlığı: </p>
                        <input type="text" id="qadd-imagelink" placeholder="Soru başlığı için resim linki girin" class="w-full text-sm border-0 outline-0 focus:ring-0 text-base p-0 p-3">
                    </div>

                    <div class="flex mt-2 items-center flex-row border rounded border-1 border-gray-300" id="qadd-target-category">
                        <p class="hidden min-w-[110px] p-3">Soru başlığı: </p>
                        <input type="text" id="qadd-category" placeholder="Virgül ile kategori belirtin, Örnek: var-mi-bilen, onerim-var" class="w-full text-sm border-0 outline-0 focus:ring-0 text-base p-0 p-3">
                    </div>

                    <div class="flex flex-row items-center mt-2 overflow-hidden py-3 fffonts-nunito">
                        <div class="w-6 h-6 bg-gray-200">
                            <input type="checkbox" class="w-full h-full ring-0 focus:ring-0 text-sm" id="qadd-anonymousmode">
                        </div>
                        <label for="qadd-anonymousmode" class="ml-3 mt-1 text-sm">Gizli olarak sormak istiyorum</label>
                    </div>
