...
<div class="w-full p-3 md:w-[800px]">
...
switch ($page){
    case "privacy": ?>
        ...
        <p>Son güncellenme: 16/08/2022</p>
        <p>
        ...
        <p>Yukarıda sayılan haklarınızı kullanmak üzere support@hsrcpay.com üzerinden bizimle iletişime geçebilirsiniz.</p>
        <h2>İletişim</h2>
        <p>
            ...
            için bizimle support@hsrcpay.com e-mail adresi üzerinden iletişime geçmekten lütfen çekinmeyiniz.
        </p>
    ...
    case "use": ?>
        ...
        <p>Son güncellenme: 16/08/2022</p>
        <p>
            Sevgili ziyaretçimiz, lütfen hsrcpay.com web sitemizi ziyaret etmeden önce işbu
        ...
        <p>
            hsrcpay.com web sitesi  tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
        ...
        <p>
            ...
            İzmir Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.
        </p>
        ...
        case "cookie": ?>
            ...
            <p>
                ...
                göz atabilir ya da bizlerle support@hsrcpay.com e-mail adresi üzerinden iletişime geçebilirsiniz.
            </p>
    <?php break;
